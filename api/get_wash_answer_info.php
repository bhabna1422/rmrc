...
function User_patient_info($data){
    ...
    if ($validation->fails()) {
        ...
        $rows=[];
        $result = db_query("SELECT `interview_date`,`visit_number`, `district_id`, `block_id`, `village_id`,`contact_number`,`sample_id`, `survey_type` FROM `answer_wash_practices`
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            $response['message'] = "Wash Practice Answer Info Found";
